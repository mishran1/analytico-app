(function () {
    ...
    angular
        .module('app')
        .controller('Home.IndexController', ['$scope', '$timeout', 'UserService', '$window', '$rootScope',
            function ($scope, $timeout, UserService, $window, $rootScope) {
                    ...
                    gapi.analytics.ready(function() {
                      ...
                      function renderYearOverYearChart(ids) {
                        ...
                        Promise.all([thisYear, lastYear]).then(function(results) {
                          ...
                          new Chart(makeCanvas('mc-container-5')).Bar(data);
